        ...
        <header className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-700 h-20 flex items-center justify-between px-6 lg:px-10 sticky top-0 z-20 transition-colors duration-200">
            <div className="flex items-center">
                ...
                <div className="hidden md:flex ml-4 relative w-96">
                    ...
                    <input
                        type="text"
                        className="block w-full pl-10 pr-4 py-2.5 border-none rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white dark:focus:bg-slate-700 transition-all duration-200 sm:text-sm"
                            ...
                            <div className="max-h-64 overflow-y-auto">
                                {notifications.length === 0 ? (
                                    ...
                                    notifications.map((notif, index) => (
                                        <div key={index} className="px-4 py-3 hover:bg-gray-50 dark:hover:bg-slate-700 border-b border-gray-50 dark:border-slate-700 last:border-0 transition-colors">
